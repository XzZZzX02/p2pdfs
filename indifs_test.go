...
import (
	...
	"github.com/XzZZzX02/p2pdfs/database/memdb"
	"github.com/XzZZzX02/p2pdfs/test_data"
)

func Test_protocolVer64(t *testing.T) {
	assert(t, protocolVer64("p2pdfs/0.1") == 0x0000000100000000)
	assert(t, protocolVer64("UNKNOWN/0.1") == 0xffffffffffffffff)
}

func Test_protocolVerMajor(t *testing.T) {
	assert(t, protocolVerMajor("p2pdfs/0.1") == 0)
	assert(t, protocolVerMajor("p2pdfs/1") == 1)
